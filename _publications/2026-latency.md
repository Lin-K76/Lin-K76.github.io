...
authors: '<strong>Linghao Kong</strong>, Megan Flynn, Michael Peng, Nir N. Shavit, Mark Kurtz, & Alexandre Marques'
citation: '<strong>Kong, L.</strong>, Flynn, M., Peng, M., Shavit, N. N., Kurtz, M., & Marques, A. (2026, May). An interpretable latency model for speculative decoding in LLM serving. arXiv preprint. https://arxiv.org/abs/2605.15051'
---
